...
EPISODES = [
    ...
    {
        "file": "silicon-valley-get-t105-comic.md",
        "arc": "Silicon Valley Get Arc — Startup English",
        "arc_id": "silicon-valley-get",
        "num": 105,
        "title": "Can You Loop Me In?",
        "color": "#0EA5E9",
        "focus": ["get looped in", "get pinged", "get up to speed"],
        "setting": "Modern San Francisco startup office, open floor plan, Slack notifications on monitors, Golden Gate poster",
        "story": [
            ("Nam's first Monday at SF rotation — Slack explodes with channels.", "PM: \"Welcome! I'll get you looped in on the launch channel.\""),
            ("Phone buzzes nonstop — Nam looks overwhelmed.", "Nam: \"Sorry — I keep getting pinged on every thread.\""),
            ("Buddy engineer shares a doc and architecture sketch.", "Buddy: \"Don't worry. We'll get you up to speed by standup tomorrow.\""),
            ("Nam reads launch doc late at night, coffee cold.", "Nam: \"There are twelve stakeholders I wasn't looped in on yet.\""),
            ("Morning standup — Nam shares progress; PM smiles about SF culture.", "Nam: \"I'm getting up to speed — but I still get pinged after hours.\" PM: \"That's startup life.\""),
            ("Hook.", "Next: We Need Buy-In"),
        ],
    },
    {
        "file": "silicon-valley-get-t106-comic.md",
        "arc": "Silicon Valley Get Arc — Startup English",
        "arc_id": "silicon-valley-get",
        "num": 106,
        "title": "We Need Buy-In",
        "color": "#0EA5E9",
        "focus": ["get buy-in", "get aligned", "get the ball rolling"],
        "setting": "SF startup war room whiteboard, sticky notes, design + eng + PM at table",
        "story": [
            ("Cross-team planning — tension in the air.", "PM: \"We can't ship without buy-in from design and legal.\""),
            ("Nam presents a simplified scope — design pushes back.", "Designer: \"We're not aligned on the user flow yet.\""),
            ("Kenji (visiting from Tokyo) joins the call on screen.", "Kenji: \"Let's get aligned on one MVP before we debate polish.\""),
            ("Whiteboard: three checkboxes — eng, design, legal.", "Nam: \"If we get buy-in on this scope, we can get the ball rolling Monday.\""),
            ("Legal nods — team aligned at last.", "Legal: \"I'm in.\" PM: \"Finally aligned — ship week, here we come.\""),
            ("Hook.", "Next: Blocked on Dependencies"),
        ],
    },
    {
        "file": "silicon-valley-get-t107-comic.md",
        "arc": "Silicon Valley Get Arc — Startup English",
        "arc_id": "silicon-valley-get",
        "num": 107,
        "title": "Blocked on Dependencies",
        "color": "#0EA5E9",
        "focus": ["get blocked", "get unblocked", "get through"],
        "setting": "SF startup desk, Jira board showing blocked ticket, dependency graph on monitor",
        "story": [
            ("Nam stares at a red BLOCKED ticket — frustration.", "Nam: \"I'm blocked on the payments API — third day.\""),
            ("Slack thread with another team — no reply.", "Nam: \"Every time I ask, I get blocked on a different dependency.\""),
            ("Kenji escalates in #platform channel.", "Kenji: \"Nam needs to get unblocked today — demo is Friday.\""),
            ("Platform engineer ships a stub endpoint.", "Platform: \"You should be unblocked now — try the staging key.\""),
            ("Nam runs tests — green checks.", "Nam: \"Once I'm unblocked, I can get through code review tonight.\" Aoi: \"Last gate before ship day.\""),
            ("Hook.", "Next: Ship It Friday"),
        ],
    },
    {
        "file": "silicon-valley-get-t108-comic.md",
        "arc": "Silicon Valley Get Arc — Startup English",
        "arc_id": "silicon-valley-get",
        "num": 108,
        "title": "Ship It Friday",
        "color": "#0EA5E9",
        "focus": ["get shipped", "get sign-off", "get ready"],
        "setting": "SF startup Friday afternoon, deploy dashboard, countdown timer, team high-fives",
        "story": [
            ("Friday 4 PM — deploy window opens.", "PM: \"We need sign-off from QA and product before we get shipped.\""),
            ("Linh runs final regression — tense silence.", "Linh: \"Staging looks good — I'll get sign-off from QA in ten minutes.\""),
            ("Nam checks rollback plan one last time.", "Nam: \"Are we ready? I want everything to get ready before we merge.\""),
            ("Green deploy pipeline — confetti Slack emoji.", "Kenji: \"Feature got shipped — nice work.\" PM: \"Sign-off, shipped, and we still have Friday night.\""),
            ("Hook.", "Next: Pulled Into the War Room"),
        ],
    },
    {
        "file": "silicon-valley-get-t109-comic.md",
        "arc": "Silicon Valley Get Arc — Startup English",
        "arc_id": "silicon-valley-get",
        "num": 109,
        "title": "Pulled Into the War Room",
        "color": "#0EA5E9",
        "focus": ["get pulled into", "get stuck", "get back to"],
        "setting": "SF startup incident war room, red alerts, paging on phones, late night",
        "story": [
            ("Nam's dinner interrupted — PagerDuty alert.", "On-call: \"Sorry — you're getting pulled into the checkout war room.\""),
            ("War room — logs scrolling, hearts racing.", "Nam: \"I'm stuck — the error only happens in prod, not staging.\""),
            ("Kenji on video from Tokyo.", "Kenji: \"Don't spin — tell PM you'll get back to them in thirty minutes.\""),
            ("Nam finds config drift — fix deploying.", "Nam: \"I'll get back to the team once rollback is confirmed.\""),
            ("Incident resolved — exhausted high-five.", "PM: \"Thanks for getting back to us.\" Nam: \"Got pulled into my first war room — and we got through it.\""),
            ("Hook.", "Next: The Acquisition News"),
        ],
    },
    {
        "file": "silicon-valley-get-t110-comic.md",
        "arc": "Silicon Valley Get Arc — Startup English",
        "arc_id": "silicon-valley-get",
        "num": 110,
        "title": "The Acquisition News",
        "color": "#0EA5E9",
        "focus": ["get face time", "get promoted", "get acquired"],
        "setting": "SF startup all-hands, acquisition announcement slide, mixed emotions in crowd",
        "story": [
            ("All-hands — CEO on stage, nervous energy.", "CEO: \"Big news — we're getting acquired by a global platform.\""),
            ("Whispers — fear and excitement.", "Nam: \"Does this mean layoffs… or opportunities?\""),
            ("VP pulls Nam aside after — rare moment.", "VP: \"I wanted face time with you before the reorg.\""),
            ("VP offers new role on integration team.", "VP: \"You're getting promoted to senior — they noticed your ship work.\""),
            ("Kenji messages from Tokyo — proud.", "Kenji: \"When a startup gets acquired, culture changes — stay flexible.\""),
            ("Nam looks at offer letter — bittersweet smile.", "Nam: \"I got face time, got promoted… and the whole company got acquired.\""),
            ("Finale.", "Nam: \"SF rotation changed me — I finally get it.\""),
        ],
    },
    # ── Switzerland Travel Arc 111–115 ──
    {
        "file": "switzerland-travel-t111-comic.md",
        "arc": "Switzerland Travel Arc — Get Around the Alps",
        "arc_id": "switzerland-travel",
        "num": 111,
        "title": "Landing in Zurich",
        "color": "#059669",
        "focus": ["get to", "get checked in", "get your bearings"],
        "setting": "Zurich airport train station, Limmat river, old town cobblestones, Swiss travel posters",
        "story": [
            ("Nam lands after long flight — reward trip after ship.", "Friend: \"Welcome! Let's get to the hotel before rush hour.\""),
            ("Hotel lobby — friendly but formal.", "Clerk: \"I'll get you checked in — passport and booking, please.\""),
            ("Nam drops bags, map upside down.", "Friend: \"Walk with me — you'll get your bearings in the old town.\""),
            ("Limmat river, church bells — Nam breathes.", "Nam: \"It took an hour to get to Zurich, but I already love it.\""),
            ("Sunset over rooftops — calm after startup chaos.", "Nam: \"Once I get my bearings, I want to explore every alley.\""),
            ("Hook.", "Next: The Glacier Express"),
        ],
    },
    {
        "file": "switzerland-travel-t112-comic.md",
        "arc": "Switzerland Travel Arc — Get Around the Alps",
        "arc_id": "switzerland-travel",
        "num": 112,
        "title": "The Glacier Express",
        "color": "#059669",
        "focus": ["get a ticket", "get on", "get off"],
        "setting": "Swiss train platform, Glacier Express panoramic windows, mountain scenery",
        "story": [
            ("Busy Zurich HB — departure board flickers.", "Nam: \"How do I get a ticket for the Glacier Express?\""),
            ("Ticket machine — friend helps.", "Friend: \"First class or second? Get a ticket with a seat reservation.\""),
            ("Wrong platform panic — train whistle.", "Nam: \"Wait — do we get on at platform 7 or 8?\""),
            ("On train — panoramic Alps, Nam awestruck.", "Friend: \"We get off at Filisur — don't miss the stop.\""),
            ("Nam almost stays on one stop too long.", "Nam: \"I nearly forgot to get off — the view hypnotized me.\""),
            ("Hook.", "Next: View from the Top"),
        ],
    },
    {
        "file": "switzerland-travel-t113-comic.md",
        "arc": "Switzerland Travel Arc — Get Around the Alps",
        "arc_id": "switzerland-travel",
        "num": 113,
        "title": "View from the Top",
        "color": "#059669",
        "focus": ["get a view of", "get altitude sickness", "get change"],
        "setting": "Jungfraujoch summit platform, snow, oxygen thin, souvenir shop",
        "story": [
            ("Cable car rises — Nam presses face to glass.", "Friend: \"From here you'll get a view of the whole Bernese Alps.\""),
            ("Summit wind — Nam dizzy, sits down.", "Nam: \"I think I'm getting altitude sickness — head is spinning.\""),
            ("Friend buys water — Nam sips slowly.", "Friend: \"Sit still. Altitude sickness passes if you rest.\""),
            ("Vending machine — coins only.", "Nam: \"Can I get change for this twenty-franc note?\""),
            ("Nam stands again — breathtaking panorama.", "Nam: \"Worth it — I got a view of mountains I'll never forget.\""),
            ("Hook.", "Next: Snowed In at Zermatt"),
        ],
    },
    {
        "file": "switzerland-travel-t114-comic.md",
        "arc": "Switzerland Travel Arc — Get Around the Alps",
        "arc_id": "switzerland-travel",
        "num": 114,
        "title": "Snowed In at Zermatt",
        "color": "#059669",
        "focus": ["get snowed in", "get held up", "get by"],
        "setting": "Zermatt village, heavy snowfall, Matterhorn hidden, cozy hotel lobby",
        "story": [
            ("Weather alert — trains cancelled.", "Hotel host: \"You might get snowed in tonight — roads are closing.\""),
            ("Nam's hiking plan cancelled — disappointment.", "Nam: \"We got held up by the avalanche warning.\""),
            ("Lobby board games — strangers share soup.", "Friend: \"We can get by with phrasebook German and gestures.\""),
            ("Nam helps translate for another tourist.", "Nam: \"English gets you by here — everyone is kind.\""),
            ("Matterhorn peek through clouds — wonder returns.", "Friend: \"Sometimes getting held up is how you meet the best stories.\""),
            ("Hook.", "Next: Lost on the Alpine Trail"),
        ],
    },
    {
        "file": "switzerland-travel-t115-comic.md",
        "arc": "Switzerland Travel Arc — Get Around the Alps",
        "arc_id": "switzerland-travel",
        "num": 115,
        "title": "Lost on the Alpine Trail",
        "color": "#059669",
        "focus": ["get around", "get lost", "get swept up in"],
        "setting": "Alpine hiking trail, cow bells, village festival in valley, sunset ride share",
        "story": [
            ("Trail fork — signpost snow-covered.", "Friend: \"Stay close — it's easy to get lost up here.\""),
            ("Fog rolls in — Nam's phone has no signal.", "Nam: \"I think we're lost — which way back to Zermatt?\""),
            ("Distant music — village festival in valley.", "Friend: \"Listen — we got swept up in a local festival by accident.\""),
            ("Dancing, fondue, warm laughter.", "Nam: \"Best wrong turn ever — I got swept up in the music.\""),
            ("Local offers ride in pickup truck.", "Local: \"I can get you a ride back — jump in the back.\""),
            ("Finale — Nam watches stars from hotel.", "Nam: \"Switzerland taught me how to get around — even when lost.\""),
        ],
    },
    # ── Everyday Get Arc 116–118 ──
    {
        "file": "english-everyday-get-t116-comic.md",
        "arc": "Everyday Get Arc — Learning English Daily",
        "arc_id": "english-everyday-get",
        "num": 116,
        "title": "First English Meetup",
        "color": "#D946EF",
        "focus": ["get used to", "get ready", "get through"],
        "setting": "Tokyo community center English meetup, name tags, nervous newcomers, warm facilitator",
        "story": [
            ("Nam at meetup door — hand on handle, hesitating.", "Nam: \"I need to get ready — deep breath.\""),
            ("Circle intro — everyone shares country and job.", "Facilitator: \"It takes time to get used to speaking English out loud.\""),
            ("Nam stumbles, group encourages.", "Nam: \"Sorry — I'm not used to talking this long in English.\""),
            ("Pair exercise — Nam finishes first mini speech.", "Partner: \"You got through the hardest part — the first five minutes.\""),
            ("Nam smiles — small victory.", "Nam: \"I got through my first meetup without switching to Vietnamese.\""),
            ("Hook.", "Next: When You Finally Get It"),
        ],
    },
    {
        "file": "english-everyday-get-t117-comic.md",
        "arc": "Everyday Get Arc — Learning English Daily",
        "arc_id": "english-everyday-get",
        "num": 117,
        "title": "When You Finally Get It",
        "color": "#D946EF",
        "focus": ["get it", "get back to", "get by"],
        "setting": "Tokyo cafe study session, grammar notebook, tutor on video call, aha moment",
        "story": [
            ("Nam struggles with phrasal verbs — frustration.", "Tutor: \"Don't memorize lists — use them until you get it.\""),
            ("Tutor explains get + preposition pattern.", "Nam: \"Oh — I get it now. Get blocked means dependency stopped me.\""),
            ("Phone buzzes — work message.", "Nam: \"Let me get back to you after this lesson — I'm studying.\""),
            ("Nam orders coffee in English — barista small talk.", "Barista: \"Your English is good — you get by fine here.\""),
            ("Nam laughs — confidence growing.", "Nam: \"I used to get by with one-word answers. Not anymore.\""),
            ("Hook.", "Next: Everyday Get Finale"),
        ],
    },
    {
        "file": "english-everyday-get-t118-comic.md",
        "arc": "Everyday Get Arc — Learning English Daily",
        "arc_id": "english-everyday-get",
        "num": 118,
        "title": "Everyday Get Finale",
        "color": "#D946EF",
        "focus": ["get onboarded", "get sign-off", "get a ride"],
        "setting": "Tokyo office morning, new hire orientation, Nam mentoring Riku, team commute",
        "story": [
            ("Riku first day — lost in hallway.", "Nam: \"I'll get you onboarded — same as my SF rotation.\""),
            ("HR checklist — Nam signs mentor form.", "HR: \"We need your sign-off as his onboarding buddy.\""),
            ("Nam reviews get-phrasal cheat sheet with Riku.", "Nam: \"Get looped in, get unblocked, get shipped — you'll hear these daily.\""),
            ("Rain after work — shared umbrella.", "Riku: \"Can I get a ride to the station with you?\""),
            ("Nam and Riku walk — full circle moment.", "Nam: \"I got onboarded once too. Now I help others get it.\""),

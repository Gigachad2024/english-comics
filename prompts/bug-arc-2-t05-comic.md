# Payment & Demo Crisis — Episode 5: Demo Flow Drill

> **File:** `bug-arc-2-t05-comic.md` · **Arc ID:** `bug-arc-2` · **Màu:** `#F97316`
> **Output:** `images/comics/bug-arc-2/tập-05/bug-arc-2-tap05-demo-flow-drill.png`
> **Attach:** `prompts/00-character-bible.md` + `prompts/00-layout-guide.md`

**Slug:** `demo-flow-drill`
...
**Next hook:** Next: When Plans Fall Through
...
ARC: Payment & Demo Crisis
EPISODE 5: Demo Flow Drill
Accent color: #F97316
...
Setting: Tokyo office war room, payment dashboard on screens

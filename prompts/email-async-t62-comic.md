# Email & Async Arc — Write Like a Pro — Episode 62: Loop Me In on the Decision

> **File:** `email-async-t62-comic.md` · **Arc ID:** `email-async` · **Màu:** `#3B82F6`
> **Output:** `images/comics/email-async/tập-62/email-async-tap62-loop-me-in-on-the-decision.png`
...
**Slug gợi ý:** `loop-me-in-on-the-decision`
...
```
ENGLISH FOCUS
  1. "Could you loop me in on...?" = Bạn có thể cập nhật tôi về...?
  2. "keep me posted on..." = nhắc tôi / cập nhật tôi về...
  3. "reach out to" = liên hệ với ai đó
Tip: Use these patterns for email async communication.
```

**Next hook:** Next: I'll Get Back to You by EOD
...
EPISODE 62: Loop Me In on the Decision
Accent color: #3B82F6
...
- "keep me posted on..." = nhắc tôi / cập nhật tôi về...
...
Footer next episode: Next: I'll Get Back to You by EOD

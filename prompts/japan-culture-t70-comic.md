# Japan Culture Arc — Explore Beyond the Guidebook — Episode 70: What Is Omotenashi?

> **File:** `japan-culture-t70-comic.md` · **Arc ID:** `japan-culture` · **Màu:** `#DC2626`
> **Output:** `images/comics/japan-culture/tập-70/japan-culture-tap70-what-is-omotenashi.png`
...
```
ENGLISH FOCUS
  1. "I'm surprised that..." = Tôi ngạc nhiên vì...
  2. "That was worth it." = Đáng giá / xứng đáng.
  3. "I'm glad that we learned the custom first." = May mà chúng ta học phong tục trước.
Tip: Use these patterns for japan culture communication.
```

**Next hook:** Next: Summer Festival Night
...
- "That was worth it." = Đáng giá / xứng đáng.
- "I'm glad that we learned the custom first." = May mà chúng ta học phong tục trước.
...
Footer next episode: Next: Summer Festival Night
